...
{
    public partial class RSortedSet<TValue> : CollectionBase, IWatchableCollection, IEnumerable
    {
        private static object _k_count = new();

        SortedSet<TValue> _set;
        ...
        public RSortedSet(IComparer<TValue> comparer = default)
        {
            _set = new(comparer);
        }
        ...
        {
            readonly RSortedSet<TValue> _set;
            SortedSet<TValue>.Enumerator _enumerator;
            ...
            internal Enumerator(RSortedSet<TValue> set)
            {
                _set = set;
